      ...
      <div className="hidden lg:flex lg:w-[440px] flex-col justify-between p-12 flex-shrink-0 bg-black">
        <div>
          ...
          <h2 className="mb-4 text-3xl font-semibold leading-snug text-orange-50">
            Controle financeiro<br />da Caracol<br />num lugar so.
          </h2>
          <p className="text-sm leading-relaxed text-orange-100/50">
            Receitas, despesas, lucro previsto vs realizado, provisionamento por moeda. Agregando NFs, fechamentos e custos avulsos.
          </p>
        </div>

        <div className="border-t border-white/10 pt-6">
          <p className="text-xs text-orange-100/40">Caracol — Suite financeira</p>
          <p className="mt-0.5 text-sm font-medium text-orange-50">Acesso restrito ao admin</p>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md">
          <div className="mb-10 flex items-center gap-3 lg:hidden">
            ...
            <span className="text-base font-semibold text-foreground">Caracol Gerencial</span>
          </div>
